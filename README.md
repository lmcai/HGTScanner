...
[IV. Complete tutorial for HGT detection in Aphyllon](https://github.com/lmcai/HGTScanner#iv-complete-tutorial-for-hgt-detection-in-aphyllon)
...
## IV. Complete tutorial for HGT detection in Aphyllon
